...
.env\Scripts\activate && python -m pytest --cov=lutils --cov-report=xml --junitxml=test-reports/junit.xml && python -m codecov --token=1aa8175d-dd1b-4608-9a44-867903349afe